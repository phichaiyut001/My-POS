...
export declare type TextFont = 'A' | 'B' | 'C' | 'D' | 'E' | 'special-A' | 'special-B';
export declare type TextSize = 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8;
export declare type TextUnderline = '1dot-thick' | '2dot-thick' | 'none';
 ...
 */
export declare type BarcodeType = 'UPC-A' | 'UPC-E' | 'JAN13' | 'JAN8' | 'CODE39' | 'ITF' | 'CODABAR' | 'CODE93' | 'CODE128' | 'GS1-128' | 'GS1 (DataBar Omnidirectional)' | 'GS1 (DataBar Truncated)' | 'GS1 (DataBar Limited)' | 'GS1 (DataBar Expanded)';
...
export declare type CashDrawerPin = '2pin' | '5pin';
